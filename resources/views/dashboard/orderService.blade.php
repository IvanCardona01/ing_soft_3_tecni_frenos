...
@section('content')
    ...
    <div class="dashboard-fondo">
        ...
        <div class="container-content-main md:p-8" style="background-color: #ffffff91; height: 100%;">
            ...
            <form method="POST" action="{{ route('dashboard.orderService.store') }}" class="space-y-8 mt-[100px]">
                @csrf
                    ...
                    <div class="form-vehicle-data">
                        <div class="form-group">
                            ...
                            <input type="text" id="brand" name="vehicle_brand"
                                placeholder="Digita marca del vehículo" value="{{ old('vehicle_brand') }}" required>
                            @error('vehicle_brand')
                                <p class="text-danger small mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                        <div class="form-group">
                            ...
                            <input type="number" id="year" name="vehicle_year"
                                placeholder="Digita año del vehículo" value="{{ old('vehicle_year') }}" required>
                            @error('vehicle_year')
                                <p class="text-danger small mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                        <div class="form-group">
                            ...
                            <input type="text" id="plate" name="vehicle_plate"
                                placeholder="Digita placa del vehículo" value="{{ old('vehicle_plate') }}" required>
                            @error('vehicle_plate')
                                <p class="text-danger small mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="model" name="vehicle_model"
                                placeholder="Digita modelo del vehículo" value="{{ old('vehicle_model') }}" required>
                            @error('vehicle_model')
                                <p class="text-danger small mt-1">{{ $message }}</p>
                            @enderror
                        </div>
