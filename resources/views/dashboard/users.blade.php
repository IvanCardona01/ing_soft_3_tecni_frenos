            ...
            @if($users->count() > 0)
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-8">
                    @foreach($users as $user)
                        <div class="flex flex-col rounded-[28px] overflow-hidden shadow-lg transition-transform duration-300 ease-out hover:scale-[1.02] bg-white">
                            <!-- Header de la card con color del sistema -->
                            <div class="bg-[#372C97] text-white flex items-center justify-center px-6 py-4">
                                <div class="flex items-center gap-3">
                                    <div class="w-12 h-12 md:w-14 md:h-14 border-[1px] border-[#F7DE0C] rounded-full flex items-center justify-center bg-white">
                            ...
                            <div class="flex flex-1 flex-col bg-[#F7DE0C] px-6 py-5">
                                <div class="space-y-4">
                                    ...
                                    <div class="flex flex-col">
                                        ...
                                        <span class="text-base md:text-lg text-[#1F1F1F] font-medium break-all">{{ $user->email }}</span>
                                    </div>
                                    ...
                                    <div class="flex flex-col">
                                        ...
                                        <span class="text-base md:text-lg text-[#1F1F1F] font-medium">{{ $user->cedula }}</span>
                                    </div>
                                    @endif
